		...
		var e = window.Crypto = {}, h = e.util = {
			...
			endian : function(a) {
				if (a.constructor == Number)
					return h.rotl(a, 8) & 16711935 | h.rotl(a, 24) & 4278255360;
			...
			bytesToBase64 : function(a) {
				...
				for ( var b = [], c = 0; c < a.length; c += 3)
					for ( var d = a[c] << 16 | a[c + 1] << 8 | a[c + 2], g = 0; g < 4; g++)
						c * 8 + g * 6 <= a.length * 8 ? b
			...
			base64ToBytes : function(a) {
				...
				for ( var b = [], c = 0, d = 0; c < a.length; d = ++c % 4)
					d != 0
							&& b
									.push(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
